...
# Rails.application.config.action_dispatch.return_only_media_type_on_content_type =
#   false
...
# not backwards compatible with earlier Rails versions. If you send mail in the
